...
const projects = {
  ...
  items: [
    {
      name: " Ecommerce App ",
      stack: ["React", "JavaScript", "Node.js","MongoDB","Clerk","Tailwind CSS"," Stripe"],
      summary: "Full E-commerce   Business  ( checkout) with auth and payments. ",
      image: "/projects/ecommerce.png",
      alt: "Ecommerce  App",
      links: [{ label: "Live", href: "https://vogues.vercel.app/" }],
    },
    {
      name: "Car-Rental",
      stack: ["React", "JavaScript", "Node.js","MongoDB","Express","Clerk","Tailwind CSS"," Stripe"],
      summary: "Full Car-Rental   Business  ( checkout) with auth and payments. ",
      image: "/projects/car-rental.jpg",
      alt: "Car Rental storefront UI",
      links: [{ label: "Live", href: " https://rentroo.vercel.app" }],
    },
    {
      name: "Portfolio v2",
      ...
      links: [{ label: "Live", href: "https://isaac-portfolio-nu.vercel.app/" }, { label: "GitHub", href: "#" }],
    },
    {
      name: "Real-Estate",
      stack: ["React", "JavaScript", "Node.js","MongoDB","Express","Clerk","Tailwind CSS"],
      summary: "Role-based dashboard with charts, filters, and server-driven tables.",
      image: "/projects/real-estate.jpg",
      alt: "Real-Estate overview",
      links: [{ label: "Live", href: "https://speedlixhomes.vercel.app/" }, { label: "GitHub", href: "#" }],
    },
  ],
};
